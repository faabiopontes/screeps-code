var roleBuilder = {
    ...
    run: function(creep) {
        ...
        if(creep.memory.building) {
            ...
            // }
            var closestSource = creep.room.find(FIND_SOURCES_ACTIVE);
            // console.log("Builder Sources");
            // console.log(JSON.stringify(closestSource));
            if (creep.harvest(closestSource[0]) == ERR_NOT_IN_RANGE) {
                creep.moveTo(closestSource[0], { visualizePathStyle: { stroke: '#009' } });
            }
        }
    }
};
